    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover">
          <thead>
              ...
              <th class="text-center" scope="col">School Image</th>
              ...
              <th class="text-center" scope="col"> School Report </th>
...
<tbody>
        ...
        $sub=0;
          ...
          ?>
              ...
              <td class="text-center"> <?php echo $row['school_district']; ?> </td>
              <td class="text-center"> <?php echo $total; ?> </td>
                <?php $hub=$row['school_id']; ?>
              
                <td class="text-center ">  <a href="schoolreportprocess.php?status=<?php echo $hub; ?> "><img src="https://img.icons8.com/color/20/000000/list.png"> <span class="mx-1 imgschool">School Report</span> </a> </td>   
