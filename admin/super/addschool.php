...
<tbody>
        ...
        $sub=0;
          ...
          ?>
              ...
              {
                ?>
               <td class="text-center"> <img class="img-fluid  mainorg rounded-pill" src="../images/school.jpg" alt="School Image not available" /> </td>
               <?php
              }
              ?>
             ...
             $file=$row['school_image'];
             ?>
              <td> <button onclick="{
  var x = confirm('Are you sure you want to delete?');
  if (x)
     window.location='delschool.php?status=<?php echo $hub;?> & unlink=<?php echo $file; ?>';
