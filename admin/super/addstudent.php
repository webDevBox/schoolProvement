 ...
 <div class="form-group">   
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover table-responsive-xs table-responsive-sm">
          <thead>
              <tr> <th colspan="10" class="text-center" scope="col">Student List</th> </tr>
              <tr>
...
<tbody>
        ...
        $sub=0;
          ...
          ?>
              ...
              $completed="completed";
              $student="student";
              $com_habit=mysqli_query($conn,"SELECT * FROM habitstatus WHERE user_role='$student' && status='$completed' && user_id='$stu_id'");
             ...
             ?>
              ...
              <td class="text-center"> <button onclick="{ var x = confirm('Are you sure you want to delete?'); if (x) {window.location='deleteStudent.php?status=<?php echo $email; ?>';} }" type="button" class="rounded-pill btn btn-danger" > Delete </button>  </td> 
