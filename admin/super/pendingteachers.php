...
<body>
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover table-responsive-xs table-responsive-sm table-responsive-md">
          <thead>
              <tr> <th colspan="10" class="text-center" scope="col">Pending Teachers List</th> </tr>
              <tr>
...
<tbody>
               <?php
        $sub=0;
          $query = "SELECT * FROM teacher WHERE teacher_account='pending'";
          ...
          ?>
              ...
              <td> <button onclick="window.location='teacherstatus.php?status=<?php echo $email; ?> & action=approved'" type="button" class="rounded-pill btn btn-success" > Approve </button>  </td> 
              <td> <button onclick="window.location='teacherstatus.php?status=<?php echo $email; ?> & action=disapproved'" type="button" class="rounded-pill btn btn-primary" > Disapprove </button>  </td>   
