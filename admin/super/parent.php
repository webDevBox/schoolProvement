...
<input type="button" name="view" value="Followed Schools" id="<?php echo $status; ?>" class="rounded-pill btn btn-success btn-xs view_data" />    
              ...
              $parent="parent";
            $completed="completed";
          $com_habit=mysqli_query($conn,"SELECT * FROM habitstatus WHERE user_role='$parent' && status='$completed' && user_id='$id'");
  ...
  if (x)
     window.location='deleteparent.php?status=<?php echo $id; ?>';
