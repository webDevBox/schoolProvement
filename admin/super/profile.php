...
<body>
    ...
    <div class="row">
      ...
      <div style="background-color: #464644" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
            <h3 class="legend">Account Setting</h3>
          </div>
         
          <div class="row d-flex justify-content-center">
          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 bg-info text-white block">
                <a href="changemail.php">
                <h2 class="text-center text-white h2 my-5">Change Profile</h2>  </a>
              </div>
              <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 bg-info text-white block">
                <a href="change.php">
                <h2 class="text-center text-white h2 my-5"> Change Password </h2>
              </div>
            </a>
