...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="addprincipal.php" method="post" enctype="multipart/form-data" class="form">
      ...
      <div class="form-group">
        ...
        <div class=" d-none form-group">
            <small id="emailHelp" class="form-text small">Enter Principal Country</small>
          <input type="text" name="country" class="form-control"  value="<?php echo $row['dist_country']; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Principal Country" required>
       
       </div>
       <div class=" d-none form-group">
        <small id="emailHelp" class="form-text small">Enter Principal State</small>
        <input type="text" name="state" class="form-control"  value="<?php echo $row['dist_state']; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Principal State" required>
 ...
 <div class=" d-none form-group">
        ...
        <input type="text"  name="dist" required class="form-control"  value="<?php echo $row['dist_name']; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Principal State" required>
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover">
          ...
          <thead>
              <tr> <th colspan="10" class="text-center" scope="col">Block Principals List</th> </tr>
              <tr>
        ...
        $sub=0;
          $query = "SELECT * from principal WHERE block='1' ";
  ...
  if (x)
     window.location='unblockprincipal.php?id=<?php echo $principal_id; ?>';
  
}" type="button" class="rounded-pill btn btn-danger" > Unblock </button>  </td> 
