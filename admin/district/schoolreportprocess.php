...
<body>
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
         ...
         <input type="submit" name="privious" value="Previous Year Record" class="btn btn-primary mt-3">
         </form>
           </div>
           ...
           <input type="submit" name="currentschool" value="Current Year Record" class="btn btn-primary mt-3">
           </form>
             </div>
