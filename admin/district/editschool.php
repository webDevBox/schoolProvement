...
<body>
    ...
    <div class="row">
    <div style="background-color: #40B84F; height: 100%;" class="col-md-2 col-lg-2 col-sm-12 col-xs-12 text-center">
        
      <h3 class="w3-bar-item text-center">Menu</h3>
     <a href="distdash.php" class="w3-bar-item text-center item">Dashboard</a>
      <hr>
      <a href="addschool.php" class="w3-bar-item text-center item">Add School</a>
      <hr>
      <a href="addteacher.php" class="w3-bar-item text-center item">Add Teacher</a>
      <hr>
     
      
    </div>
  
    <div style="background-color: grey" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
...
<form action="editprocess.php" method="post" class="form">
      ...
      <div class="form-group">
          <input type="text" name="country" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['school_country']; ?>" required>
          <small id="emailHelp" class="form-text small">Enter School Country</small>
       </div>
        <div class="form-group">
          <input type="text" name="state" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['school_state']; ?>" required>
          <small id="emailHelp" class="form-text small">Enter School State</small>
       </div>
       <div class="form-group">
        <?php
        $sql=mysqli_query($conn,"SELECT * FROM district");
         ...
         <small id="emailHelp" class="form-text small">Select School District</small>
       </div>
