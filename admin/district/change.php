            ...
            if (preg_match('/[a-z]/', $paa)) {
                if (preg_match('/[0-9]/', $paa)) {
                    if ($ab >= 8) {
                        ...
                        if ($new == $cpass) {
                            $sql1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM district WHERE dist_id='$id'"));
                            $datapass = $sql1['dist_password'];
                            if ($old == $datapass) {
                                $sql2 = mysqli_query($conn, "UPDATE district SET dist_password='$new' WHERE dist_id='$id'");
                                if ($sql2) {
                                    ?>
                                    <script>
