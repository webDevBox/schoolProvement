...
if (isset($_SESSION['id1'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM principal WHERE principal_email='$email'"));
        if($older == $email)
        {
            ?>
            <script>
    ...
    <?php 
            ...
            {
                $query1=mysqli_query($conn,"UPDATE principal SET principal_email='$email' WHERE principal_id='$pid'");
                if($query1)
                {
                    ?>
                    <script>
    ...
    <?php include "sidebar.html"; ?>
                ...
                <div style="background-color: #464644" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                    ...
                    <h1 class="text-center dash"><?php echo $schoolName; ?> School Principal Dashboard</h1>
                    </div>

                    <div class="container">
                        <form action="#" method="post" class="form">

                            <legend class="legend"><?php echo $lang['cm']; ?></legend>
                            <div class="form-group">
                                <label id="emailHelp" class="form-text required"><?php echo $lang['enm'];?></label>
