...
if (isset($_SESSION['id1'])) {
    $id = $_SESSION['id1'];
    $school=mysqli_query($conn,"SELECT * FROM principal WHERE principal_id='$id'");
            ...
            if (preg_match('/[a-z]/', $paa)) {
                if (preg_match('/[0-9]/', $paa)) {
                    if ($ab >= 8) {
                        ...
                        if ($new == $cpass) {
                            $sql1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM principal WHERE principal_id='$id'"));
                            $datapass = $sql1['principal_password'];
                            if ($old == $datapass) {
                                $sql2 = mysqli_query($conn, "UPDATE principal SET principal_password='$new' WHERE principal_id='$id'");
                                if ($sql2) {
                                    ?>
                                    <script>
                ...
                <div style="background-color: #464644" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                    ...
                    <div class="container">
                        <form action="#" method="post" class="form">
                            ...
                            <legend class="legend"><?php echo $lang['cp']; ?></legend>
                            <div class="form-group">
                                <label id="emailHelp" class="form-text required"><?php echo $lang['eop']; ?></label>
                            ...
                            <div class="form-group">
                                <label id="emailHelp" class="form-text required"><?php echo $lang['enp']; ?></label>
                                <input type="password" name="new" class="form-control" id="psw" aria-describedby="emailHelp" placeholder="New Password" required>

                            </div>
                            <div class="form-group">
                                <label id="emailHelp" class="form-text required"><?php echo $lang['cop']; ?></label>
