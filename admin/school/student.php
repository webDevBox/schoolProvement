    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="studentadd.php" method="post" class="form">
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
          ...
          <h1 class="text-center dash"><?php echo $lang['dad']; ?></h1>
           ...
           <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2 mt-3 text-right">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover table-responsive-xs table-responsive-sm">
          <thead>
              <tr> <th colspan="10" class="text-center" scope="col"><?php echo $lang['stl']; ?></th> </tr>
              <tr>
...
<tbody>
               <?php
        $sub=0;
          $query = "SELECT * from student WHERE school_id='$s_id'";
          ...
          ?>
             ...
             ?>
              ...
              <td> <button onclick="{ var x = confirm('Are you sure you want to delete?'); if (x) {window.location='deletestudent.php?status=<?php echo $email; ?>';} }" type="button" class="rounded-pill btn btn-danger" > Delete </button>  </td> 
    ...
    function ConfirmDelete()
{
 ...
 if (x)
    window.location='deleteStudent.php?status=<?php echo $email; ?>';
