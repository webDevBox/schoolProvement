...
$result = mysqli_query($con,"SELECT * FROM school where school_name = '$school'");
...
<body class="inner-page">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<ul>
							...
							<li><?php echo $row['country_name'] ?></li>
							<li><?php echo '// '.$row['school_district'] ?></li>
	...
	<?php	$sql=mysqli_query($con,"SELECT * FROM school WHERE school_name='$school'");
        $query=mysqli_fetch_assoc($sql);
		$school_id=$query['school_id'];
		if($query['attendance_percentage']==null){
			$Attendence_rate=0;	
		}else{$Attendence_rate=$query['attendance_percentage'];}
        
        $sql1=mysqli_query($con,"SELECT * FROM teacher WHERE school_id='$school_id'");
        $abs=0;
	...
	<div class="rs-team-single pt-100 mb-50">
		<div class="container">
			<div class="row team">
				<div class="col-lg-4 col-md-12">
					<div class="team-photo mobile-mb-40">
						<center><?php	if($row['school_image'] == null)
									{
							...
							<?php }else
									{
										?>
							<a href="#"><img src="admin/school/image/<?php echo $row['school_image'] ?>"
									style="height:256px;" class="img-fluid rounded " alt="" /></a>
							<?php			}
										?></center>

						<div class="team-title" style="text-align:center; margin-top: 10px;;">
							<h3 class="team-name" style="text-transform: capitalize;">
								<?php echo $row['school_name']; ;?></h3>
							<p><span class="fa fa-map-marker"> <b style="text-transform: capitalize;"> &nbsp;
										<?php echo $row['school_district'].',';;?>

										<?php echo $row['school_state'].', '.$row['country_name'];?></b> </span>
							</p>
				...
				<div class="col-lg-8 col-md-12">
					...
					<div class="team-skill">
						<h3 class="skill-title" style="text-align: center;">School Statistics</h3>

						<div class="col-md-12">
							<div class="row">
								<div class="col-md-3" onclick="myFunction1()">
									<p style="margin-top:120px; font-size:60px; text-align:center"><?php echo  $abs ?>
									</p>
									<p style="margin-top: 80px;"><b style="text-align:left;"><center><a
								...
								<div class="col-md-6" style="margin-top:60px;">
									...
									<div class="round" data-value="<?php echo '.'.$Attendence_rate; ?>" data-size="150"
										data-thickness="10">
										<strong><?php echo  $Attendence_rate."%"; ?></strong>



									</div>
									<h3 style="text-align:center;">Average Teachers’ Attendance</h3>


								</div>
								<div class="col-md-3" onclick="myFunction()">

									<p style="margin-top:120px; font-size:60px; text-align:center"><?php echo  $avr ?>/5
	...
	<?php
	 ...
	 $v4=0;
	 $v5=0;
	   $sql3=mysqli_query($con,"SELECT * FROM schoolfeedback WHERE school_id='$school_id'");
	...
	<div class="container" id="myDIV" style="background-color:rgb(39, 109, 196); border-radius:5px; ">
	...
	<div class="container" id="myDIV1"
		...
		<?php 
		$ab1=mysqli_query($con,"SELECT * FROM reportabsence WHERE school_id='$school_id' AND attendance_status = 'absent' ");
		...
		?>
		<div>
			<h3 class="h3 text-center text-white">Teacher Absences
			</h3>
			<?php 
					if($count > 0)
{
...
$teacher=$ab_row['teacher_id'];

					     	$ab12=mysqli_query($con,"SELECT * FROM teacher WHERE teacher_id='$teacher' ");
		
		   $ab_row12=mysqli_fetch_assoc($ab12);
					       echo $ab_row12['teacher_firstName']; 
...
$sql4=mysqli_query($con,"SELECT * FROM schoolfeedback WHERE school_id='$school_id'");
                          ...
                          ?>
							   ...
							   ?>
								...
								<div class="com1">
									...
									$string = $sub['schoolFeedback_review'];;
									if (strlen($string) > 50) {
								...
								?> <p> <?php	echo $string;
?></p>
<p style="text-align:right; font-size:10px;"> <?php	echo $sub['feedback_date'];?></p>
								</div>
								<div class="com2" style="display:none">
									<p> <?php	echo $sub['schoolFeedback_review'];
?></p>
