...
if(isset($_SESSION['id1']))
{
    ...
    {
    $status=$_GET['status'];
    $sql=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM teacher WHERE teacher_email='$status'"));
    $teacher=$sql['teacher_firstName'].' '.$sql['teacher_lastName'];
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
          <div class="row">
            ...
            <h1 class="text-center dash"><?php echo $teacher; echo " "; echo $lang['report']; ?></h1>
       </div>
     ...
     <input type="submit" name="privious" value="Previous School Year Records" class="btn btn-primary mt-3">
     </form>
       </div>

       <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5">
     
       <form action="principalreport.php" method="post">
        <div class="form-group d-none">
          <input type="text" name="school" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $status; ?>">
         
       </div>
       <input type="submit" name="currentschool" value="Current School Year Records" class="btn btn-primary mt-3">
       </form>
         </div>
     ...
     <div class="form-group d-none">
       ...
       <input type="submit" name="fullschool" value="All Records" class="btn btn-primary mt-3">
                ...
                <form action="principalreport.php" method="post" enctype="multipart/form-data" class="form">
              ...
              <div class="form-group">
               ...
               <div class="form-group d-none">
                  <input type="text" name="teacher" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $status; ?>">
               </div>
        
             <center> <input  type="submit" name="submit" value="submit" class="btn mb-2 btn-primary"> </center>
