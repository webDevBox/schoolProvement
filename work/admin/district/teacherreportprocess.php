...
if (isset($_SESSION['id2'])) {
    ...
    ?>
                <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
                                <form action="#" method="post">
                                    ...
                                    <input type="submit" name="pevoius" value="Previous Year Record" class="btn btn-primary mt-3">
                                </form>
                            </div>

                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
                                <form action="districtreport.php" method="post">
                                    <div class="form-group d-none">
                                        <input type="text" name="teacher" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $status; ?>">

                                    </div>
                                    <input type="submit" name="currentteachers" value="Current Year Record" class="btn btn-primary mt-3">
                                </form>
                            </div>
                            ...
                            <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
                                <form action="districtreport.php" method="post">
                                    ...
                                    <input type="submit" name="full" value="All Records" class="btn btn-primary mt-3">
                                </form>
                            </div>
                    ...
                    <form action="districtreport.php" method="post" enctype="multipart/form-data" class="form">
