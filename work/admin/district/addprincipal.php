...
if(isset($_SESSION['id2']))
{
    if(isset($_POST['submit']))
    {
        ...
        if($query2 == 0)
        {
            ...
            $insert=mysqli_query($conn,"INSERT INTO principal(principal_name,principal_email,principal_password,country_name,principal_district,school_id,principal_joiningDate,principal_account,principal_reset_password)
            values('$name','$email','$pass','$country','$dist','$school_id','$date','approved',0)");
            if($insert)
            {
                ?>
                <script>
