    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><?php echo $lang['ap']; ?></h5>
       ...
       <div class="form-group">
        <small id="emailHelp" class="form-text small required"><?php echo $lang['epn']; ?></small>
      ...
      <div class="form-group">
        <small id="emailHelp" class="form-text small required"><?php echo $lang['epe']; ?></small>
        ...
        <div class=" d-none form-group">
          <input type="text" name="country" class="form-control"  value="<?php echo $row['country_name']; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Principal Country" required>
       </div>
      
 <div class=" d-none form-group">
     
        <small id="emailHelp" class="form-text small required"><?php echo $lang['spd']; ?></small>
      ...
      <div class="form-group">   
        ...
        $sql=mysqli_query($conn,"SELECT * FROM school WHERE school_district = '$aa'");
         ?>
         <small id="emailHelp" class="form-text small required"><?php echo $lang['sps']; ?></small>
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        $sub=0;
          $query = "SELECT * from principal WHERE principal_account='approved' and principal_district= '$aa'";
