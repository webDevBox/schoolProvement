...
<body>
    ...
    <div class="row">
      ...
      <div style="background-color: #464644" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
            <h3 class="legend"><?php echo $lang['as'];  ?></h3>
          </div>
          ...
          <div class="row d-flex justify-content-center">
              ...
              <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 bg-info text-white block">
                ...
                <h2 class="text-center text-white h2 my-5"><?php echo $lang['cmail'];  ?>  </h2>  </a>
              </div>
              <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 bg-info text-white block">
                <a href="change.php">
                <h2 class="text-center text-white h2 my-5"><?php echo $lang['cp'];  ?>  </h2>  </a>
              </div>
