    ...
    foreach($checkbox1 as $chk1)  
       ...
       $type = $chk;
        ...
        if ($sql) {
            ?>
            <script>
                window.alert("Notification Added");
            ...
            ?>
            <script>
                window.alert("Notification Not Added");
                window.location.href = 'notification.php';
            </script>
            <?php
        }
                    ...
                    <div class="modal-content">
                        ...
                        <form action="#" method="post" class="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="user[]" value="Students">Students<br/>
                                <input type="checkbox" name="user[]" value="Parents">Parents<br/>
                                <input type="checkbox" name="user[]" value="Community Members">Community Members<br/>
                                <input type="checkbox" name="user[]" value="Teachers">Teachers<br/>
                                <input type="checkbox" name="user[]" value="Principals">Principals<br/>
                            ...
                            <center> <input type="submit" id="submit11" name="specific" value="Send" class="btn btn-primary"> </center>
