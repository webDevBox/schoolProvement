      ...
      <div class="modal-content">
        ...
        <form action="distprocess.php" method="post" class="form">
          ...
          $sql2=mysqli_query($conn,"SELECT * FROM country");
           ?>
                  <small id="emailHelp" class="form-text small required">Select District Country</small>
          ...
          <div class="form-group">   
            <small id="emailHelp" class="form-text small required">Enter District Admin Email</small>
            <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="District Admin Email" required>
    ...
    <div style="background-color: #464644;" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <table id="tableid" class="table table-dark table-striped table-bordered table-hover table-responsive-xs table-responsive-sm">
              ...
              $sub=0;
                ...
                $query = "SELECT * from district WHERE dist_account='approved'";
                ...
                ?>
                    ...
                    <td class="text-center"> <?php echo $row['dist_userName']; ?> </td>
                    ...
                    <td> <button onclick="{  var x = confirm('Are you sure you want to delete?'); if (x){window.location='deldistrict.php?status=<?php echo $status; ?>';} }" type="button" class="rounded-pill btn btn-danger text-center" > Delete </button>  </td> 
                    <td> <button onclick="window.location='editdist.php?status=<?php echo $status; ?>'" type="button" class="rounded-pill btn btn-primary text-center" > Edit </button>  </td>   
