            ...
            if (preg_match('/[a-z]/', $paa)) {
                if (preg_match('/[0-9]/', $paa)) {
                    if ($ab >= 8) {
                        ...
                        if ($new == $cpass) {
                            $sql1 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM super WHERE username='$user'"));
                            $datapass = $sql1['password'];
                            if ($old == $datapass) {
                                $sql2 = mysqli_query($conn, "UPDATE super SET password='$new' WHERE username='$user'");
                                if ($sql2) {
                                    ?>
                                    <script>
                                ...
                                <script>
                                    ...
                                    window.location.href = 'superchangepassword.php?user=<?php echo $user; ?>';
                                </script>
                                <?php
                            }
                        } else {
        ...
        <div  class="bg" style="background-color: #464644">
            ...
            <div class="container">
                <form action="#" method="post" class="form-container">
                    ...
                    <input class="form-control" type="password" placeholder="Enter New Password" name="new" id="psw" required><br>
                    ...
                    <br>
                    <center>  <input type="submit" name="super" id="submit" value="Change Password" class="btn btn-primary"> </center>  
