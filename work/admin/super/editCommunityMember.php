...
<body>
    ...
    <div style="background-color: #464644" class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
        ...
        <div class="w3-container">
          ...
          <?php
            $email=$_GET['status'];
           $sql1=mysqli_query($conn,"SELECT * FROM communitymember WHERE communityMember_email='$email'");
           $row=mysqli_fetch_assoc($sql1);
          ?>

<form action="editCommunityMemberProcess.php" method="post" class="form">
          
          <legend class="legend">Update Communiy Member</legend>
      <div class="form-group">
         <small id="emailHelp" class="form-text small required">Enter Name</small>
        <input type="text" name="fname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['communityMember_anonymous_name']; ?>" required>
      
      </div>
  
        <div class="form-group">
           <small id="emailHelp" class="form-text small required">Enter Email</small>
         <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['communityMember_email']; ?>" required>
      
       </div>
        <div class="form-group d-none">
         
         <input type="text" name="status" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row['communityMember_email']; ?>" required>
       ...
       <div class="form-group">
        ...
        $sql=mysqli_query($conn,"SELECT * FROM district");
         ?>
         <small id="emailHelp" class="form-text small required">Select District</small>
